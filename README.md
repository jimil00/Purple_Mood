...
## 개요
> 수행 기간: 2022년 10월 31일~2022년 11월 18일<br>
수행 인원: 5명
...
## 담당 역할
+ [TMDB API를 활용한 콘텐츠 데이터 수집](#TMDB-API를-활용한-콘텐츠-데이터-수집---담당)
+ 서버 구축 및 DB 관리
+ 회의록 작성
+ [관리자 페이지](#관리자-페이지---담당)
...
## 프로젝트 참여 소감
> 프로젝트를 통해 그동안 학습한 내용을 정리하고, AWS나 Open API를 활용한 데이터 수집 등 새로운 기술을 습득할 수 있어 재밌었습니다. 그러나 처음 다뤄보는 기술이었기 때문에 해당 기술에 관한 조사와 공부에 많은 시간을 투자해야 했고, 이 때문에 계획보다 더 많은 시간이 소요되어 일부 기능을 포기하게 되어 아쉬움이 남았습니다. 이 경험을 통해 프로젝트를 시작하기 전에 필요한 기술과 지식에 관한 충분한 조사가 필요하다는 것을 배웠습니다. 다음 프로젝트에서는 이전 프로젝트에서 얻은 경험을 적극적으로 활용하여 더욱 완성도 높은 결과물을 만들어 내고자 합니다.
