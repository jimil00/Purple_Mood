...
public class FileControl {
	 ...
	 * @throws IOException
	 */
	public void save(HttpServletRequest request,String path, String paramName) throws IOException {
		...
		this.sysName = multi.getFilesystemName(paramName);
		this.oriName = multi.getOriginalFileName(paramName); 
	}
