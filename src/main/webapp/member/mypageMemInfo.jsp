			...
			<div class="modifyForm col-12">
				...
				<div class="nickname col-12">
					<span>닉네임<span class="requiredField">*<span></span>
							<div class="margin_top col-12">
								<input type="text" name="nickname" id="nickname" placeholder="2~8자 영문 대 소문자,한글" readonly value="${dto.nickname}">
				...
				<div class="pw col-12">
					<span>패스워드<span class="requiredField">*<span></span>
							<div class="margin_top col-12">
								<input type="password" name="pw" id="pw" placeholder="8~20자 영문 대 소문자,숫자,특수문자(~!@#$%)" readonly>
							</div>
				</div>
				...
				<div class="name col-12">
					<span>이름<span class="requiredField">*<span></span>
							<div class="margin_top col-12">
								<input type="text" name="name" id="name" placeholder="2~5자 한글" value="${dto.name}" readonly>
							</div>
				</div>
				<div class="phone col-12">
					<span>전화번호<span class="requiredField">*<span></span>
							<div class="margin_top col-12">
								<input type="text" name="phone" id="phone" placeholder="숫자만 입력" value="${dto.phone}" readonly>
							</div>
				</div>
				<div class="email col-12">
					<span>이메일<span class="requiredField">*<span></span>
							<div class="margin_top col-12">
								<input type="text" name="email" id="email" placeholder="영어 대 소문자, 숫자" value="${dto.email}" readonly> @ <select id="emailAddress" name="emailAddress" class="selectOption">
				...
				<div class="postcode col-12">
					<div class="col-12">
						<span>우편번호</span>&nbsp&nbsp<input type="button" onclick="postcode()" value="우편번호 찾기" id="btnsearch" style="width: 100px;" readonly>
					</div>
					<div class="margin_top col-12">
				...
				<div class="address1 col-12">
					<span>주소</span>
					<div class="margin_top col-12">
						<input type="text" name="address1" id="address1" placeholder="주소" value="${dto.address1}" readonly>
					</div>
				</div>
				<div class="address2 col-12">
					<span>상세주소</span>
					<div class="margin_top col-12">
						<input type="text" name="address2" id="address2" placeholder="상세주소" value="${dto.address2}" readonly>
					</div>
				</div>
				<div class="footer col-12">
					<div class="btns">
						<input type="button" class="btn" id="modify" value="수정하기"> <a href="/main"><input type="button" class="btn" id="back" value="홈으로"></a>
					</div>
				</div>
