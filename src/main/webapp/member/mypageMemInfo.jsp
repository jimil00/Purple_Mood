    ...
    <form action="/updateMemInfo.member" method="post" id="frm">
                ...
                <div class="modifyForm col-12">
                    ...
                    <div class="email col-12">
                        <span>이메일<span class="requiredField">*<span></span>
                                <div class="margin_top col-12">
                                    <input type="text" name="email" id="email" placeholder="영어 대 소문자, 숫자" value="${dto.email}" readonly> @
                                    <select id="emailAddress" name="emailAddress" class="selectOption">
                    ...
                    <div class="postcode col-12">
                        <div class="col-12">
                            <span>우편번호</span>&nbsp&nbsp<input type="button" onclick="postcode()" value="우편번호 찾기"
                                id="btnsearch" style="width: 100px;" readonly>
                        </div>
                        <div class="margin_top col-12">
        ...
        <div class="footer col-12">
            <div class="btns">
                ...
                <a href="/index.jsp"><input type="button" class="btn" id="back" value="홈으로"></a>
            </div>
        </div>
