	...
	<form action="/updateContent.board?b_seq=${dto.b_seq}" method="post">
		<table border="1" width="500" align="center">
			...
			<tr>
				...
				<td colspan="3"><div id="b_content" name="b_content" cols="131"
						rows="15" readonly>${dto.b_content }</div></td>
			</tr>
			<c:choose>
							...
							<c:when test="${loginNickname == comment.bcm_writer}">
								<td class="cbtns" align="center"><input type="button"
									...
									href="/deleteBoardComment.boardcomment?bcm_seq=${comment.bcm_seq }&b_seq=${dto.b_seq}"><button
											type="button" class="deleteBoardComment"
											name="deleteBoardComment">댓글삭제</button></a></td>
							</c:when>
							<c:otherwise>
								<td><a
