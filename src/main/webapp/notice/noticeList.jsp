				...
				<div class="row">
					<div class="notice col-12">
										...
										<div class="content col-12">
											<div class="row">
												<div class="contentTitle col-12">
													<a href="/selectNoticeContents.notice?n_seq=${notice.n_seq}" style="text-decoration: none">${notice.n_title}</a>
												</div>
											</div>
											<div class="row">
						...
						<div class="insertBoardContents">
							<a href="/notice/insertNoticeContents.jsp"><button type="button" id="insertNoticeContentsBtn">글쓰기</button></a>
						</div>
						<hr>
						<div align="center" class="navi">
							<a href="noticeList.notice?cpage=1"><button type="button">처음으로</button></a> ${navi} <a href="noticeList.notice?cpage=${endNavi}"><button type="button">끝으로</button></a>
						</div>
						<hr>
